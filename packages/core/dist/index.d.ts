...
export declare function quantum-js(tag: string | Function | symbol, props: Record<string, any> | null, ...children: any[]): HTMLElement | DocumentFragment;
export declare const jsx: {
    createElement: typeof quantum-js;
};
